...
$sentencia="SELECT * FROM usuarios WHERE usuarios.NomUsuario='".$_SESSION["user"]."';";
...
<main>
  ...
  <form action="confirmacionModificar.php" class="formularioregistro" method="post">
    ...
    <label for="rcontraseña">Contraseña:</label><input type="text" id="rcontraseña" name="ncontrasena" placeholder="Contraseña" <?php echo "value='".$misdatos["Clave"]."'"?>><br><br>
    <label for="repetircontraseña">Repetir contraseña:</label><input type="text" id="repetircontraseña" name="rcontrasena" placeholder="Contraseña" <?php echo "value='".$misdatos["Clave"]."'"?>><br><br>
